                            ...
                            <div class="col-xs-12 col-lg-10 offset-lg-1 c-gutter-20">
                                ...
                                <form class="pt-10" action="#" method="POST">
                                    <div class="row ">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="text" name="name" placeholder="Ad soyad" class="form-control" pattern="[a-zA-ZĞÜŞİÖÇIğüşiöçı]+\s{0,1}[a-zA-ZĞÜŞİÖÇIğüşiöçı]*\s{0,1}[a-zA-ZĞÜŞİÖÇIğüşiöçı]*" required oninvalid="this.setCustomValidity('Bu alan özel karakter içeremez ve boş bırakılamaz!')"
