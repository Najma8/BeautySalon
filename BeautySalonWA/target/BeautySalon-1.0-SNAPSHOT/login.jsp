                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" class="my-login-validation" novalidate="" action="#">
                                            <div class="form-group">
                                                ...
                                                <input id="email" type="email" class="form-control" name="email" value="<%=sname %>" required autofocus>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="password" type="password" class="form-control" name="password"  value="<%=spassword%>" required data-eye>
                                                    <div class="invalid-feedback">
                                                        Şifre gereklidir!
                                                    </div>
                                            </div>
                        ...
                        if (girisoldumu) 
                        {
                            ...
                            session.setMaxInactiveInterval(86400);
                             ...
                             if(request.getParameter("remember") != null )
                              {
                                 Cookie myemail = new Cookie("email",request.getParameter("email"));  
                                 Cookie mypassword = new Cookie("password",request.getParameter("password"));
                                 myemail.setMaxAge(60*60*24); 
                                 mypassword.setMaxAge(60*60*24); 
